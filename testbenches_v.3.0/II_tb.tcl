...
probe -create -database waves rs_tb.rs_I.imm_ii2rs
probe -create -database waves rs_tb.rs_I.opcode_rs2ex rs_tb.rs_I.rdADD rs_tb.rs_I.rdADD_rs2ex
probe -create -database waves rs_tb.rs_I.rs1 rs_tb.rs_I.rs1_rs2ex
probe -create -database waves rs_tb.rs_I.rs2 rs_tb.rs_I.rs2_rs2ex
probe -create -database waves rs_tb.rs_I.tag_rs2ex
probe -create -database waves rs_tb.rs_I.res_n
...
simvision -input II_tb.tcl.svcf
